...
Sx_test_data_path = r'C:/Users/chesily/Desktop/附件1-P300脑机接口数据/S5/S5_test_data.xlsx'
Sx_test_event_path = r'C:/Users/chesily/Desktop/附件1-P300脑机接口数据/S5/S5_test_event.xlsx'
...
def main():
    ...
    x_test = np.array(x_test).reshape(np.array(x_test).shape[0],32,20,1)
